...
sleep 2
#mail -s "VGR Orders <<<MISSING>>> !!! - $ctm" procurement.2ndline.int@ebuilder.com procurement.2ndline@ebuilder.com < $INT_MIS_REP
mail -s "VGR Orders <<<MISSING>>> !!! - $ctm" sagara.jayathilaka@ebuilder.com < $INT_MIS_REP
#
else
#
...
#
#mail -s "VGR Orders check !!! - $ctm" procurement.2ndline.int@ebuilder.com procurement.2ndline@ebuilder.com < $ORD_CHK
mail -s "VGR Orders check !!! - $ctm" sagara.jayathilaka@ebuilder.com < $ORD_CHK
#
fi
