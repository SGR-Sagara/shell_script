...
sleep 2
#mail -s "VGR ORDRSP Copy back <<<MISSING>>> !!! - $ctm" procurement.2ndline.int@ebuilder.com procurement.2ndline@ebuilder.com < $INT_MIS_REP
mail -s "VGR ORDRSP Copy back <<<MISSING>>> !!! - $ctm" sagara.jayathilaka@ebuilder.com < $INT_MIS_REP
#
else
#
echo "VGR ordrsp verification result !!!" > $RSP_CHK
echo "Time duration $tm1 to $tm2" >> $RSP_CHK
echo " " >> $RSP_CHK
...
echo " " >> $RSP_CHK
#
#mail -s "VGR ORDRSP copy back check !!! - $ctm" procurement.2ndline.int@ebuilder.com procurement.2ndline@ebuilder.com < $RSP_CHK
mail -s "VGR ORDRSP copy back check !!! - $ctm" sagara.jayathilaka@ebuilder.com < $RSP_CHK
#
fi
