#!/bin/bash
PATH="/usr/java/jre1.5.0_15/bin:/opt/mxib/xib/local/bin:/opt/mxib/xib/bin:/opt/oracle/home/bin:/opt/s24/bin:/opt/s24/sbin:/usr/kerberos/bin:/usr/local/bin:/bin:/usr/bin:/opt/mxib/bin:/opt/mxib/scripts/verify/src:/opt/mxib/scripts/verify/sql"
SHELL=/bin/bash
. /etc/profile
#
#. ../sql/vvgr-db-order-list.sh
. ../src/vgr-db-access.txt
. ./vgr-db-order-list.sh
#
#
